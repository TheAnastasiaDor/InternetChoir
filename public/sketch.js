...
// // Create a button
  ...
  button.addEventListener('click', ()=> {
    ...
    let disappearedText = document.getElementById('status');
    disappearedText.innerHTML = '  ♫  ';
    let space = document.getElementById('noteAndVolume');
    space.style.paddingBottom = '41.8px';
  });
